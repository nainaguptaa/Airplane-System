...
public class FlightController implements ActionListener {
    ...
    // String departureTime = rs.getString("departure_time"); // Adjust format as
    // needed
    ...
    // flightList.add(new FlightViewModel(flightId, departureCode, arrivalCode,
    // departureTime, arrivalTime, price, flightNumber));
    // }
